...
db.trabajador.insertOne(trabajador1);
db.trabajador.insertOne(trabajador2);
db.trabajador.insertOne(trabajador3);
db.trabajador.insertOne(trabajador4);
db.trabajador.insertOne(trabajador5);
db.trabajador.insertOne(trabajador6);
