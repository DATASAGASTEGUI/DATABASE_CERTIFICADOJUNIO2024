...
public class OtorgarPrivilegios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmdRevocarPrivilegios, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cmdOtorgarPrivilegiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOtorgarPrivilegiosActionPerformed
        ...
        for (int index : privilegiosIndices) {
            ...
            System.out.println(privilegiosUsuarios[j]);
            j++;
    ...
    private void cmdRevocarPrivilegiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdRevocarPrivilegiosActionPerformed
        ...
        // Opcionalmente, puedes mostrar un mensaje de éxito
        System.out.println("Revocar privilegios con éxito.");
